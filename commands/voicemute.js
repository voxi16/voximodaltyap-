...
module.exports.run = async (client, message, args) => {
  moment.locale('tr')
    ...
    if (!message.member.roles.cache.has(ayarlar.vmute) && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send(`${message.author}, **Bu Komutu Kullanmaya Yetkin Yok!**`)
...
\`•\` Ses Mute Sebebi: \ [\`${reason}\`]
    ...
    .setFooter("Voxi ❤️ Deuslra")
      ...
      client.channels.cache.get("841691424068337694").send(voxi)  
